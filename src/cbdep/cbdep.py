...
from cbdep.__version__ import __version__
...
class Cbdep:
    ...
    def loadconfig(args):
        ...
        return importlib.resources.read_text(cbdep, "cbdep.config")
    ...
    def do_list(self, args):
        ...
        with open(self.loadconfig(args)) as y:
...
def main():
    ...
    parser.add_argument(
        ...
        version=f"cbdep version {__version__}"
    )
